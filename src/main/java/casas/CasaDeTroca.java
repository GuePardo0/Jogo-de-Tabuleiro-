...
public class CasaDeTroca extends Casa {
    ...
    public void aplicarEfeito() {
        ...
        request += "Você pode trocar suas moedas por itens especiais:\n\n";
        ...
        switch (userInput) {
            case "bone":
                if (jogador.getMoedas() >= 7) {
                    jogador.setMoedas(jogador.getMoedas() - 7);
                    jogador.getItens().add("boné");
                ...
                break;
            case "moleton":
                if (jogador.getMoedas() >= 15) {
                    jogador.setMoedas(jogador.getMoedas() - 15);
                    jogador.getItens().add("moleton");
                ...
                break;
            case "oculos escuros":
                if (jogador.getMoedas() >= 27) {
                    jogador.setMoedas(jogador.getMoedas() - 27);
                    jogador.getItens().add("óculos escuros");
