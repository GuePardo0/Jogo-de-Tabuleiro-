...
import main.Clear;
import main.Jogador;
import main.JogadorAzarado;
import main.JogadorComSorte;
import main.JogadorNormal;
import main.Jogo;
...
public class Main {
    public static void main(String[] args) {
         ...
         * Jogador j1 = new JogadorComSorte("azul");
         * jogadores.add(j1);
         * Jogador j2 = new JogadorComSorte("roxo");
         * jogadores.add(j2);
         * Jogador j3 = new JogadorComSorte("branco");
         * jogadores.add(j3);
         * Tabuleiro tabuleiro = new Tabuleiro();
         * tabuleiro.mostrarTabuleiro(jogadores);
         * for (int jogador = 0; jogador < jogadores.size(); jogador++) {
         * System.out.println(jogadores.get(jogador).getCor());
         * }
         */
    }
        ...
        do {
            ...
            for (int i = 0; i < numeroDeJogadores; i++) {
                ...
                do {
                    ...
                    new Clear();
                    if (!(jaEscolheu && tipoDoJogador.equals(""))) { // verificar se o usuário digitou uma
                                                                     // opção válida
            ...
            do {
                ...
                switch (userInput) {
                    case "s":
                        ...
                        String primeiroJogador = tiposDosJogadores.get(0);
                        for (int i = 0; i < numeroDeJogadores; i++) {
        ...
        do {
            ...
            for (int i = 0; i < numeroDeJogadores; i++) {
                ...
                do {
                    ...
                    new Clear();
                    if (!(jaEscolheu && corDoJogador.equals(""))) { // verificar se o usuário digitou uma
                                                                    // opção válida
